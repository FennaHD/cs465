"""
Implementation of the S-box in 5.1.1
"""
class SBox:
	...
	"""
	Given a nibble as a string, returns the index that it would be in the s_box.
	E.g. "0" returns 0, "a" returns 10, "f" returns 16, etc. Naturally, the nibble
	can only have values 0-9 and a-f.
	"""
	@staticmethod
	def get_s_box_index(nibble):
	...
	def get_transformation(self, byte):
		...
		row = self.get_s_box_index(nibbles[0])
		col = self.get_s_box_index(nibbles[1])
